...
class IsEventRelatedToUnreachableItemUseCaseTest {
    ...
    private fun reachableCounterCondition(): TriggerCondition.OnCounterCountReached =
        TriggerCondition.OnCounterCountReached(
            ...
            comparisonOperation = io.github.vibhor1102.macrion.core.domain.model.counter.ComparisonOperation.GREATER,
    ...
    private fun unreachableChangeCounterAction() = io.github.vibhor1102.macrion.core.domain.model.action.ChangeCounter(
        id = ACTION_ID,
        eventId = EVENT_ID,
        priority = 0,
        counterName = COUNTER_NAME,
        operation = io.github.vibhor1102.macrion.core.domain.model.action.ChangeCounter.OperationType.SET,
