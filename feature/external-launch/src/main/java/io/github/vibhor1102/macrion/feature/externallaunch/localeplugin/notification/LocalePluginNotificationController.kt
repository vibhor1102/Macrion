 ...
 */
package io.github.vibhor1102.macrion.feature.externallaunch.localeplugin.notification
...
import io.github.vibhor1102.macrion.feature.externallaunch.localeplugin.ui.LocalePluginExecutionActivity
...
class LocalePluginNotificationController @Inject constructor(
    ...
    fun showLaunchFallback(
        ...
        NotificationManagerCompat.from(context).notify(
            ...
            NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(io.github.vibhor1102.macrion.core.ui.R.drawable.ic_intent)
    ...
    fun showError(messageRes: Int) {
        ...
        NotificationManagerCompat.from(context).notify(
            ...
            NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(io.github.vibhor1102.macrion.core.ui.R.drawable.ic_warning)
