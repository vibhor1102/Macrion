 ...
 */
package io.github.vibhor1102.macrion.core.common.actions.notification
...
import io.github.vibhor1102.macrion.core.common.actions.R
...
private const val USER_SCENARIO_CHANNELS_GROUP_ID = "Macrion User Scenarios"
/** The channel identifier for the notification sent by a user scenario with LOW importance. */
private const val USER_SCENARIO_LOW_CHANNEL_ID = "MacrionScenario LOW"
/** The channel identifier for the notification sent by a user scenario with DEFAULT importance. */
private const val USER_SCENARIO_DEFAULT_CHANNEL_ID = "MacrionScenario DEFAULT"
/** The channel identifier for the notification sent by a user scenario with HIGH importance. */
private const val USER_SCENARIO_HIGH_CHANNEL_ID = "MacrionScenario HIGH"
